...
export function navbarHtml(activePage = "home") {
    return `
    <header class="app-header animate-slide-down">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <nav class="hidden md:flex items-center gap-1">
                <a href="/" class="btn-ghost ${activePage === 'home' ? 'text-violet-400' : ''}">Inicio</a>
                ...
                <a href="/mascotas" class="ml-2 inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 text-sm font-semibold hover:bg-cyan-500/20 transition-all duration-200 ${activePage === 'mascotas' ? 'bg-cyan-500/20 border-cyan-500/50' : ''}">
                    🐾 Mascotas
                </a>
            </nav>
        ...
        <div id="mobile-nav" class="md:hidden flex-col gap-2 px-6 pb-5 border-t border-violet-500/15 pt-4">
            <a href="/" class="block px-4 py-3 rounded-xl text-slate-300 hover:text-violet-400 hover:bg-violet-500/10 font-semibold transition-all">Inicio</a>
            ...
            <a href="/mascotas" class="block px-4 py-3 rounded-xl text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 font-semibold transition-all">🐾 Mascotas</a>
        </div>
    </header>
    `;
}
